                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.column}>
                        ...
                        <ul className={styles.linkList}>
                            ...
                            <li className={styles.linkItem}>
                                <a href="https://github.com/RavikantiAkshay/basic-lab-guide/issues" target="_blank" rel="noopener noreferrer" className={styles.link}>
                                    Report an Issue
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className={styles.column}>
                        ...
                        <div className={styles.socialGrid}>
                            ...
                            <a href="https://linkedin.com/in/akshayravikanti" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="LinkedIn">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <a href="https://twitter.com/akshayravikanti" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="X (Twitter)">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <p className={styles.copyrightInline}>
                            © {currentYear} Akshay Ravikanti. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
