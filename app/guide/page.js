...
const CATEGORIES = [
    {
        ...
        description: 'Learn how to find labs, search for experiments, and navigate the guide.',
        icon: '🧭',
        steps: [
            'Master Lab Index',
            'Cross-lab search',
        ...
        <div className={styles.guideContainer}>
            <header className={styles.header}>
                ...
                <p className={styles.subtitle}>
                    What exactly do you want to master today? Choose a category to start your journey.
                </p>
            </header>
            ...
            <footer className={styles.footer}>
                <p>New to Bhilai EE Labs? We recommend following the guide in numerical order.</p>
            </footer>
        </div>
    );
}
